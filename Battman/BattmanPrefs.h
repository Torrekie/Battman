...
#define kBattmanPrefs_TEMPERATURE_UNIT_FAHRENHEIT "TEMPERATURE_UNIT_FAHRENHEIT"
...
typedef enum {
	...
	TAT_SECT_THERM_PREVIEW,
	TAT_SECT_COUNT,
} ThermAniSect;

// TAT_SECT_THERM_RANGE
typedef enum {
	TAT_ROW_THERM_RANGE_MIN,
	TAT_ROW_THERM_RANGE_MAX,
	TAT_ROW_THERM_RANGE_COUNT,
} ThermAniRowRange;
...
// TAT_SECT_THERM_PREVIEW
typedef enum {
	TAT_ROW_THERM_PREVIEW,
	TAT_ROW_THERM_PREVIEW_COUNT,
} ThermAniRowPreview;
